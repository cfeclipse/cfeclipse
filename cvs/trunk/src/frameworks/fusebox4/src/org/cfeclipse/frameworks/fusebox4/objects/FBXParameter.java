 ...
 *
 */
public class FBXParameter implements IFBXObject{
	...
	public String getName() {
		if(this.xmlNode != null){
			String paramName = this.xmlNode.getAttributes().getNamedItem("name").getNodeValue();
			String paramValue = this.xmlNode.getAttributes().getNamedItem("value").getNodeValue();
