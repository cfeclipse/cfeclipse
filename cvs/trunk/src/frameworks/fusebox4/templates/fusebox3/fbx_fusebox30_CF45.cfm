...
<cftry>
	...
	<cfcatch>
		...
		<cfoutput>The variable "attributes.fuseaction" is not available or the Fusebox framework could not find the circuit you requested: "#fusebox.circuit#". If you think this error is incorrect, turn off the Fusebox suppress error messages flag by setting fusebox.SuppressErrors to FALSE, and you will receive ColdFusion's "normal" error output.<p></cfoutput><cfrethrow><cfabort>
	</cfcatch>
</cftry>
