 ...
 */
package com.rohanclan.cfml.editors.partition;
 ...
 *
 * This is an attempt to create a more flexible and powerful 
 * partitioner than the default RuleBasedPartitionScanner.
 * 
 * Very much a work in progress at the minute. 
 */
public class CFEDefaultPartitioner implements IDocumentPartitioner, IDocumentPartitionerExtension, IDocumentPartitionerExtension2 {
	 ...
	 */
	public CFEDefaultPartitioner(IPartitionTokenScanner scanner, String[] legalContentTypes) {
		fScanner= scanner;
