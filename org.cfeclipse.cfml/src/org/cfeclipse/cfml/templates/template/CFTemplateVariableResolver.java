 ...
 */
public class CFTemplateVariableResolver extends TemplateVariableResolver {
	/*
	...
	protected String[] resolveAll(TemplateContext context) {
		String[] proposals= new String[] { "${srcDir}", "${dstDir}","${access}","${hint}", "nuts" }; //$NON-NLS-1$ //$NON-NLS-2$
