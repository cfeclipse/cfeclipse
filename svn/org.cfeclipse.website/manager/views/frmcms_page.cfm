    ...
    <input type="hidden" name="pageid" value="#cms_pageRecord.getpageid()#" />
        ...
        <div class="formfield">
	        ...
	        <div>
		        ...
		        <textarea class="input" id="pagedescription" name="pagedescription" cols="80" rows="24"><cfoutput>#cms_pageRecord.getpagedescription()#</cfoutput></textarea>
        ...
        <div class="formfield">
		 ...
		 --->
				<select name="childpages|pageid" multiple="true">
				<cfoutput query="valueQuery">
					<option value="#valueQuery.pageid#" <cfif listFindNoCase(selectedList, "#valueQuery.pageid#")> selected</cfif>>#valueQuery.pagename#</option>
          		</cfoutput>
			</select>
        ...
        <!---   <cfoutput query="valueQuery">
			...
			<select name="articles|art_id" multiple="true">
				<cfoutput query="valueQuery">
					<option value="#valueQuery.art_id#" <cfif listFindNoCase(selectedList, "#valueQuery.art_id#")> selected</cfif>>#valueQuery.art_title#</option>
          		</cfoutput>
			</select>
