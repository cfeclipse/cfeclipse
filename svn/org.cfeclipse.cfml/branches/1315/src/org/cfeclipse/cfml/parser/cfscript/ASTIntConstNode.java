...
public class ASTIntConstNode extends SimpleNode {
  ...
  public String toString(String prefix) {
  	...
  	if(this.aNodeToken == null)
  		nodeToken = " node token is null!";
  	else
  		nodeToken = "token: " + this.aNodeToken.image + ", line " + this.aNodeToken.beginLine;
  	
  	return super.toString(prefix) + "with a value of " + val + " and " + nodeToken;
  }
