...
public class FormattingPreferences {
	 ...
	 * 
	 * @param prefs
	 *            the preference store to use as a reference for the formatting
	 *            preferences
	 */
	...
	public boolean changeTagCase() {
		return fPrefs.getBoolean(EditorPreferenceConstants.FORMATTER_CHANGE_TAG_CASE);
	}

	public boolean changeTagCaseUpper() {
		return fPrefs.getBoolean(EditorPreferenceConstants.FORMATTER_CHANGE_TAG_CASE_UPPER);
	}
