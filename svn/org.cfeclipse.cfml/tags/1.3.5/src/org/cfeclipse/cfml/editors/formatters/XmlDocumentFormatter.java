...
public class XmlDocumentFormatter {
    ...
    private static class TextReader extends TagReader {
        ...
        /* (non-Javadoc)
         * @see org.cfeclipse.cfml.editors.formatter.XmlDocumentFormatter.TagReader#getStartOfTag()
         */
        public String getStartOfTag() {
            return ""; //$NON-NLS-1$
        }
        ...
        /* (non-Javadoc)
         * @see org.cfeclipse.cfml.editors.formatter.XmlDocumentFormatter.TagReader#isTextNode()
         */
        public boolean isTextNode() {
        ...
        /* (non-Javadoc)
         * @see org.cfeclipse.cfml.editors.formatter.XmlDocumentFormatter.TagReader#requiresInitialIndent()
         */
        public boolean requiresInitialIndent() {
            return false;
        }
        ...
        /* (non-Javadoc)
         * @see org.cfeclipse.cfml.editors.formatter.XmlDocumentFormatter.TagReader#startsOnNewline()
         */
        public boolean startsOnNewline() {
            return false;
        }
