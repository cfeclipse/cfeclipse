 ...
 *        Revision 1.2  2004/11/10 22:43:36  smilligan
 *        Added an AlertUtils class to as a simple way to show messages to the user.
 *
 *        Added custom icon overlays for files and directories that are read only and not accessible in both local file system and remote FTP sites.
 *
